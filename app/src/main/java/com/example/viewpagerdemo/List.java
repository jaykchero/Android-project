...
public class List extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        lvProduct = (ListView) view.findViewById(R.id.lv3);
        return view;
    }
    ...
    static class ProductAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.tvName.setText(map.get("timenow"));
            holder.tvDescribe.setText(map.get("temper")+"C");
            holder.tvPrice.setText(map.get("deepth"));
